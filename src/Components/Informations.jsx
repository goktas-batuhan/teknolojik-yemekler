    ...
    <div className="bilgiler-background">
      <div className="bilgiler">
        <div className="yarim-pizza">
          <img
            className="bilgiler-yarim-pizza"
            src="assets/iteration-2-images/pictures/form-banner.png"
            alt="yarim-pizza"
          />
        </div>
        ...
        <div className="bilgiler-pizza-aciklama">
          <div className="bilgiler-pizza-baslik">
            <h4 className="bilgiler-pizza-baslik">
              Position Absolute Acı Pizza
            </h4>
          </div>
          <div className="bilgiler-pizza-degerlendirme">
            <p className="bilgiler-pizza-degerlendirme-fiyat">85.50₺</p>{" "}
            <p className="bilgiler-pizza-degerlendirme-yorum">4.9</p>
            <p className="bilgiler-pizza-degerlendirme-yorum">(200)</p>
          </div>
          <div className="bilgiler-pizza-aciklama">
