...
export default function Success() {
  ...
  const { boyut, hamur, ekMalzemeler, adet } = location.state || {
    boyut: "",
    hamur: "",
    ekMalzemeler: [],
    adet: 1,
    ...
    <>
      <div className="all-succes">
        <div className="succes-main-div">
          <img src="assets/iteration-1-images/logo.svg" alt="logo" />
          ...
          <div className="pizza-infos">
            ...
            <p className="pizza-infos-p">
              EkMalzemeler: <span>{ekMalzemeler.join(", ")} </span>
            </p>
          </div>
          <div className="succes-hesap">
            <div className="succes-hesap-inner">
              <h4 className="hesap-baslik">Sipariş Toplamı</h4>
              <div className="succes-sipasi-inner">
                <p className="hesap-yazi">Seçimler:</p>
                <p>{secimTutari.toFixed(2)}₺</p>
              </div>
              <div className="succes-sipasi-inner">
                <p className="hesap-yazi">Toplam:</p>
